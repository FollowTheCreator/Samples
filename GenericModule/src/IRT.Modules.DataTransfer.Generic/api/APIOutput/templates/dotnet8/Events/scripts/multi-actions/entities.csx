...
IEnumerable<Action> WriteEntity(EntityInfo entityInfo)
{
    ...
    //if ((entityInfo.EnumInfo != null
    //    || SeedData.TryGetValue(entityInfo.NameInfo, out IReadOnlyList<JObject> seedDataObjects)
    //        && seedDataObjects.Any()) && ProjectLayout != "gqapi")
    //{
    //    actions.AddRange(WriteEntitySeedData(entityInfo));
    //}

    //if (!entityInfo.IsAutoGenerated)
    //{
    //    actions.AddRange(WriteEntityGraphQLTypes(entityInfo));
    //}
