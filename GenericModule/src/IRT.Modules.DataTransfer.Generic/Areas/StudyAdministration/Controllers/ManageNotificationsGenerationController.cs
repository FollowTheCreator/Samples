...
{
    [AllowAuthorizedFor(Operations.GenericDataTransfer.ViewManageNotificationsGeneration)]
    [Area(Shared.Helpers.Constants.AreaNames.StudyAdministration)]
    public class ManageNotificationsGenerationController : EntityCrudController
    {
        public ManageNotificationsGenerationController(
