...
IEnumerable<Action> WriteEntityClasses(EntityInfo entityInfo)
{
    return new Action[]
    {
        () => Template.WriteFile("templates/entity.cst", entityInfo.GetPathName(Targets.Controller, ".cs"), new { Entity = entityInfo }),
    };
}

/// <summary>
/// Write the adf query classes
/// </summary>
IEnumerable<Action> WriteAdfQueries(EntityInfo entityInfo)
    => new Action[]
    {
    };

/// <summary>
/// Write any seed-data files, if this entity has seed data.
/// </summary>
IEnumerable<Action> WriteEntitySeedData(EntityInfo entityInfo)
    => new Action[]
    {
        () => Template.WriteFile("type-config-seed-data.cst", entityInfo.GetPathName(Targets.EntityTypeConfig, ".SeedData.generated.cs"), new { Entity = entityInfo }),
    };

/// <summary>
/// Write the classes required to expose this entity in GraphQL as a queryable type.
/// </summary>
IEnumerable<Action> WriteEntityGraphQLTypes(EntityInfo entityInfo)
    => new Action[]
    {
    };

/// <summary>
/// Write the classes required to allow access to this entity through a repository.
/// </summary>
IEnumerable<Action> WriteRepository(EntityInfo entityInfo)
    => new Action[]
    {
        () => Template.WriteFile("repository.cst", entityInfo.GetPathName(Targets.EntityRepository, ".generated.cs"), new { Entity = entityInfo }),
        () => Template.WriteFileIfNotExists("repository.partial.cst", entityInfo.GetPathName(Targets.EntityRepository, ".cs"), new { Entity = entityInfo }),
        () => Template.WriteFile("repository-interface.cst", entityInfo.GetPathName(Targets.EntityRepositoryInterface, ".generated.cs"), new { Entity = entityInfo }),
        () => Template.WriteFileIfNotExists("repository-interface.partial.cst", entityInfo.GetPathName(Targets.EntityRepositoryInterface, ".cs"), new { Entity = entityInfo }),

        () => Template.WriteFile("repository-readonly.cst", entityInfo.GetPathName(Targets.EntityReadOnlyRepository, ".generated.cs"), new { Entity = entityInfo }),
        () => Template.WriteFileIfNotExists("repository-readonly.partial.cst", entityInfo.GetPathName(Targets.EntityReadOnlyRepository, ".cs"), new { Entity = entityInfo }),
        () => Template.WriteFile("repository-readonly-interface.cst", entityInfo.GetPathName(Targets.EntityReadOnlyRepositoryInterface, ".generated.cs"), new { Entity = entityInfo }),
        () => Template.WriteFileIfNotExists("repository-readonly-interface.partial.cst", entityInfo.GetPathName(Targets.EntityReadOnlyRepositoryInterface, ".cs"), new { Entity = entityInfo }),
    };
...
IEnumerable<Action> WriteDtoCommandPartials(EntityInfo entityInfo, TypeInfo typeInfo)
    => new Action[]
    {
        () => Template.WriteFile("adfcommand-type-id.cst", typeInfo.GetPathName(Targets.Type, ".identityprovider_generated.cs"), new { Entity = entityInfo, Type = typeInfo })
    };

IEnumerable<Action> WriteDtoArchiver(EntityInfo entityInfo, TypeInfo typeInfo)
    => new Action[]
    {
        () => Template.WriteFile("adfcommand-entity-archiver.cst", Path.Combine(entityInfo.GetPath(Targets.AdfEntityArchiver), $"{typeInfo.GetName(Targets.AdfEntityArchiver)}.generated.cs"), new { Entity = entityInfo, Type = typeInfo }),
        () => Template.WriteFileIfNotExists("adfcommand-entity-archiver.partial.cst", Path.Combine(entityInfo.GetPath(Targets.AdfEntityArchiver), $"{typeInfo.GetName(Targets.AdfEntityArchiver)}.cs"), new { Entity = entityInfo, Type = typeInfo })
    };

IEnumerable<Action> WriteDtoFactory(EntityInfo entityInfo, TypeInfo typeInfo)
    => new Action[]
    {
        () => Template.WriteFile("adfcommand-entity-factory.cst", Path.Combine(entityInfo.GetPath(Targets.AdfEntityFactory), $"{typeInfo.GetName(Targets.AdfEntityFactory)}.generated.cs"), new { Entity = entityInfo, Type = typeInfo }),
        () => Template.WriteFileIfNotExists("adfcommand-entity-factory.partial.cst", Path.Combine(entityInfo.GetPath(Targets.AdfEntityFactory), $"{typeInfo.GetName(Targets.AdfEntityFactory)}.cs"), new { Entity = entityInfo, Type = typeInfo })
    };

IEnumerable<Action> WriteDtoUpdater(EntityInfo entityInfo, TypeInfo typeInfo)
    => new Action[]
    {
        () => Template.WriteFile("adfcommand-entity-updater.cst", Path.Combine(entityInfo.GetPath(Targets.AdfEntityUpdater), $"{typeInfo.GetName(Targets.AdfEntityUpdater)}.generated.cs"), new { Entity = entityInfo, Type = typeInfo }),
        () => Template.WriteFileIfNotExists("adfcommand-entity-updater.partial.cst", Path.Combine(entityInfo.GetPath(Targets.AdfEntityUpdater), $"{typeInfo.GetName(Targets.AdfEntityUpdater)}.cs"), new { Entity = entityInfo, Type = typeInfo })
    };

IEnumerable<Action> WriteCommandValidator(AdfCommandKind kind, EntityInfo entityInfo, TypeInfo typeInfo)
    => new Action[]
    {
        () => Template.WriteFile($"adfcommand-{kind.ToString().ToLower()}-validator.cst", Path.Combine(entityInfo.GetPath(Targets.AdfDeleteCommandValidator), $"{typeInfo.GetName(GetValidatorTargetKind(kind))}.generated.cs"), new { Entity = entityInfo, Type = typeInfo}),
        () => Template.WriteFileIfNotExists($"adfcommand-{kind.ToString().ToLower()}-validator.partial.cst", Path.Combine(entityInfo.GetPath(Targets.AdfDeleteCommandValidator), $"{typeInfo.GetName(GetValidatorTargetKind(kind))}.cs"), new { Entity = entityInfo, Type = typeInfo})
    };

string GetValidatorTargetKind(AdfCommandKind kind)
    => kind switch 
    {
        AdfCommandKind.Create => Targets.AdfCreateCommandValidator,
        AdfCommandKind.Update => Targets.AdfUpdateCommandValidator,
        AdfCommandKind.Delete => Targets.AdfDeleteCommandValidator,
        AdfCommandKind.Upsert => Targets.AdfUpsertCommandValidator,
        _ => throw new ArgumentException($"The AdfCommandKind {kind} does not have a target validator.")
    };