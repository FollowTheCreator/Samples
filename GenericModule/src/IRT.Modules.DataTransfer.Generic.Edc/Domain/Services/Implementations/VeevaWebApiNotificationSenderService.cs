...
{
    public class VeevaWebApiNotificationSenderService : WebApiNotificationSenderService, IVeevaWebApiNotificationSenderService
    {
        ...
        public VeevaWebApiNotificationSenderService(
        ...
        protected override bool SendNotificationInternal(NotificationSqlView notification)
        {
            var notificationDefinitionIds = NotificationDefinitionRegistry.GetNotificationDefinitions(null)
              .Where(x => x.PendingNotificationSenderTypes.Contains(typeof(VeevaWebApiNotificationSenderService)))
              .Select(x => x.Id)
              .ToList();
        ...
        private bool ProcessClientNotificationResult(HttpResponseMessage response, Guid clientNotificationId)
        {
            ...
            CommandBus.SendCommand(new VeevaAcknowledgeClientNotification
            {
                ClientNotificationId = clientNotificationId,
                IsSuccess = isSuccess,
