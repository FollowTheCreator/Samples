...
{
    [Description("GenericSubjectNotificationDataProvider")]
    public class GenericSubjectNotificationDataService : BaseGenericNotificationDataService<GenericSubjectViewModel>
    {
        public GenericSubjectNotificationDataService(
