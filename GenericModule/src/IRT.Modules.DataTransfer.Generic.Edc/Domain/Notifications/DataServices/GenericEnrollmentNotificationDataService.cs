...
{
    [Description("GenericEnrollmentNotificationDataProvider")]
    public class GenericEnrollmentNotificationDataService : BaseGenericNotificationDataService<GenericEnrollmentViewModel>
    {
        private readonly IQueryable<SubjectVisitSqlView> subjectVisitQuery;

        public GenericEnrollmentNotificationDataService(
