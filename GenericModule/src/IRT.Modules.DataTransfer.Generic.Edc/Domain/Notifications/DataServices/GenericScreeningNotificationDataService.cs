...
{
    [Description("GenericScreeningNotificationDataProvider")]
    public class GenericScreeningNotificationDataService : BaseGenericNotificationDataService<GenericScreeningViewModel>
    {
        public GenericScreeningNotificationDataService(
