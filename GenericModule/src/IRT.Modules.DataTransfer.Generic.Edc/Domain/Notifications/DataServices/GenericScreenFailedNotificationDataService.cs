...
{
    [Description("GenericScreenFailedNotificationDataProvider")]
    public class GenericScreenFailedNotificationDataService : BaseGenericNotificationDataService<GenericScreenFailedViewModel>
    {
        public GenericScreenFailedNotificationDataService(
