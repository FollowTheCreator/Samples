...
{
    [Description("RaveScreeningNotificationDataService")]
    public class RaveScreeningNotificationDataService : BaseGenericNotificationDataService<RaveScreeningViewModel>
    {
        public RaveScreeningNotificationDataService(
