...
{
    [Description("RaveSubjectNotificationDataService")]
    public class RaveSubjectNotificationDataService : BaseGenericNotificationDataService<RaveScreeningViewModel>
    {
        public RaveSubjectNotificationDataService(
